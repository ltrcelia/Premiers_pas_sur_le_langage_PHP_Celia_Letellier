...
$array = [
    1 => [
        ...
        'pictures' => '<img src="img/clark-van-der-beken.png" alt="Dodomu">',
    ],
    2 => [
        'link' => 'oeuvre.php?id=2',
        ...
        'pictures' => '<img src="img/pawel-czerwinski-3.png" alt="Aashaaheen Baadal">',
    ],
    3 => [
        'link' => 'oeuvre.php?id=3',
        ...
        'pictures' => '<img src="img/dan-cristian-padure.png" alt="Nightlife Traffic">',
    ],
    4 => [
        'link' => 'oeuvre.php?id=4',
        ...
        'pictures' => '<img src="img/steve-johnson-5.png" alt="Le refuge de l\'Havre">',
    ],
    5 => [
        'link' => 'oeuvre.php?id=5',
        'title' => 'Red Washover',
        ...
        'pictures' => '<img src="img/steve-johnson.png" alt="Red Washover">',
    ],
    6 => [
        'link' => 'oeuvre.php?id=6',
        'title' => 'Chromatics',
        ...
        'pictures' => '<img src="img/pawel-czerwinski.png" alt="Chromatics">',
    ],
    7 => [
        'link' => 'oeuvre.php?id=7',
        ...
        'pictures' => '<img src="img/jazmin-quaynor.png" alt="Digital Negative">',
    ],
    8 => [
        'link' => 'oeuvre.php?id=8',
        ...
        'pictures' => '<img src="img/steve-johnson-6.png" alt="Blast from the past">',
    ],
    9 => [
        'link' => 'oeuvre.php?id=9',
        'title' => 'Hurricane',
        ...
        'pictures' => '<img src="img/victor-grabarczyk.png" alt="Hurricane">',
    ],
    10 => [
        'link' => 'oeuvre.php?id=10',
        ...
        'pictures' => '<img src="img/pawel-czerwinski-2.png" alt="La marée rouge">',
    ],
    11 => [
        'link' => 'oeuvre.php?id=11',
        'title' => 'Asimilacion',
        ...
        'pictures' => '<img src="img/steve-johnson-2.png" alt="Asimilacion">',
    ],
    12 => [
        'link' => 'oeuvre.php?id=12',
        ...
        'pictures' => '<img src="img/fly-d.png" alt="La Galaxia Gialla">',
    ],
    13 => [
        'link' => 'oeuvre.php?id=13',
        ...
        'pictures' => '<img src="img/orfeas-green.png" alt="Puffy Amalgamate">',
    ],
    14 => [
        'link' => 'oeuvre.php?id=14',
        'title' => 'Mirag',
        ...
        'pictures' => '<img src="img/steve-johnson-4.png" alt="Mirage">',
    ],
    15 => [
        'link' => 'oeuvre.php?id=15',
        ...
        'pictures' => '<img src="img/steve-johnson-3.png" alt="Blaue Gelbe Muster">',
    ],
];
